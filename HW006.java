...
// Написать метод, который будет запрашиватьу пользователя критерий(или критерии)
// фильтрации и выведет ноутбуки, отвечающие фильтру.
// Критерии фильтрации можно хранить в Мар.
...
public class HW006 {
    public static void main(String[] args) {
        ...
        System.out.println();
        Catalog nout_1 = new Catalog("Honor MagikBook 2021", 8, 1024, "Windows 11", "серый");
        Catalog nout_2 = new Catalog("Huawei MateBook 15", 8, 512, "Windows 11 Home", "серый");
        Catalog nout_3 = new Catalog("Huawei Laptop 16", 16, 256, "DOS", "серебристый");
        Catalog nout_4 = new Catalog("Asus VivoBook 14", 8, 512, "Windows 11 Home", "синий");
        Catalog nout_5 = new Catalog("Apple Makbook Pro", 4, 1024, "DOS", "белый");
